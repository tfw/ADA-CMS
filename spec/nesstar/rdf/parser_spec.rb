...
describe Nesstar::RDF::Parser do
  ...
  context "parsing study documents " do
   ...
   context "parsing related materials documents" do
     it "should parse the study from a related materials document" do
       rm_list = Nesstar::RDF::Parser.parse_related_materials_document(File.expand_path("test@relatedMaterials.xml", File.dirname(__FILE__)))
       rm_list.each do |related|
         related[:study_resource].should_not be_nil
       end
     end
   end
   
   context "parsing variables" do
