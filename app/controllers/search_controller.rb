class SearchController < ContentController
  ...
  def facets
    ...
    @archive_facets = {Archive.social_science => (Study.facets params[:facet], :conditions => {:archive_id => Archive.social_science.id}),
      Archive.historical => (Study.facets params[:facet], :conditions => {:archive_id => Archive.historical.id}),
      Archive.indigenous => (Study.facets params[:facet], :conditions => {:archive_id => Archive.indigenous.id}),
      Archive.longitudinal => (Study.facets params[:facet], :conditions => {:archive_id => Archive.longitudinal.id}),
      Archive.qualitative => (Study.facets params[:facet], :conditions => {:archive_id => Archive.qualitative.id}),
      Archive.international => (Study.facets params[:facet], :conditions => {:archive_id => Archive.international.id})            
      }
